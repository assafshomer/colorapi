...
var asset = {
    ...
    metadata: {
        ...
        userData : {
            ...
            products:  [ 
            { key: 'xxx', value: '82760', type: 'Number' },
            { key: 'consectetur', value: 'Labore nisi deserunt aliqua duis cupidatat consectetur sunt ipsum. Duis enim qui velit incididunt consectetur consectetur velit proident eiusmod ex fugiat id. Ad elit voluptate pariatur amet amet reprehenderit quis elit voluptate do tempor. Commodo ad mollit non deserunt quis dolor dolor anim irure.', type: 'Text' },
            { key: 'bue', value: true, type: 'Boolean' } 
           ]
        },
        encryptions: [
